...
const String _imagemH15 = 'assets/images/tela_inicial.png';
...
const List<Cena> h15Cenas = [
  ...
  Cena(
    ...
    imagem: _imagemH15,
    texto: 'Qual laboratorio voce quer verificar?',
    opcoes: [
      OpcaoCena(texto: 'S01', proximaCena: 5),
      OpcaoCena(texto: 'S02', proximaCena: 6),
      OpcaoCena(texto: 'S03', proximaCena: 7),
